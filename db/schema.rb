...
ActiveRecord::Schema.define(version: 20150603073604) do
  ...
  add_index "hacks", ["cached_votes_score"], name: "index_hacks_on_cached_votes_score"
  add_index "hacks", ["cached_votes_total"], name: "index_hacks_on_cached_votes_total"
  add_index "hacks", ["cached_votes_up"], name: "index_hacks_on_cached_votes_up"
  add_index "hacks", ["cached_weighted_average"], name: "index_hacks_on_cached_weighted_average"
  add_index "hacks", ["cached_weighted_score"], name: "index_hacks_on_cached_weighted_score"
  add_index "hacks", ["cached_weighted_total"], name: "index_hacks_on_cached_weighted_total"
